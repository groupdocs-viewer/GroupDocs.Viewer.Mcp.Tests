#!/bin/bash
################################################################################
# GroupDocs.Viewer.Mcp — Integration Test Runner (local)
#
...
#   - RenderPage (single-page PNG rendering across PDF/Word/Excel/PowerPoint)
#   - GetViewInfo (file type, page count, per-page dimensions)
...
#   --filter PATTERN        Run only tests matching pattern (e.g., GetViewInfo)
...
#   ./02_test-all-scenarios.sh --version 26.7.0 --filter GetViewInfo
...
TEST_PROJECT_DIR="$PROJECT_ROOT/src/GroupDocs.Viewer.Mcp.Tests"
...
main() {
    ...
    echo ""
    echo "╔════════════════════════════════════════════════════════════╗"
    echo "║  GroupDocs.Viewer.Mcp — Integration Test Runner (local) ║"
    echo "╚════════════════════════════════════════════════════════════╝"
    echo ""
